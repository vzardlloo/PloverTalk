...
<html>
<head>
<title>PloverTalk</title>
<link href="CSS/style.css" rel="stylesheet">
<script type="text/javascript" src="${ pageContext.request.contextPath }/js/jquery-1.8.3.js"></script>
<script type="text/javascript">
var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临聊PloverTalk,我们尽情畅聊吧！</span><br><span style='line-height:22px;'>";var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临PloverTalk,我们尽情畅聊吧！</span><br><span style='line-height:22px;'>";
...
<body>
	...
	<table width="778" height="95" border="0" align="center"
		cellpadding="0" cellspacing="0" bordercolor="green"
		...
		<form action="" id="form1" name="form1" method="post">
			...
			<tr>
				...
				<td colspan="2" align="center" class="word_dark">&nbsp;All
					CopyRights reserved 安徽啄木鸟信息科技有限公司</td>
				<td align="center">&nbsp;</td>
			</tr>
		</form>
	</table>
